...
export const Financial = () => {
    return <div className='flex justify-between'>
        ...
        <div className='flex items-center'>
            <button className='flex items-center justify-center bg-[#D2E0D4] px-9 py-1.5'>
             ...
             <button className='flex items-center justify-center border-l border-r border-white bg-[#DCCFFC] pl-2 pr-2 py-1.5'>
             ...
             <button className='flex items-center justify-center bg-[#FAC2AF] px-3 py-1.5'>
                <img src={ActionButton} alt="" className='text-gray-300' />
             ...
             <button className='flex items-center justify-center bg-gray-200 border-l border-white text-3xl font-thin px-11'>
                +
            </button>
        </div>
    </div>
